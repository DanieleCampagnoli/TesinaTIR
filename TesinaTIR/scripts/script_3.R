...
plot(bins[1:14],bins_norm_durations_tcp[1:14],col="blue",type="o",ann=FALSE,xaxt="n",yaxt="n")
axis(1, at =seq(0,max(bins[1:14]),30), las=2)
axis(2, at =seq(0,max(bins_norm_durations_tcp[1:14]),0.1), las=2)
box()
...
plot(bins[1:13],bins_norm_durations_udp[1:13],col="blue",type="o",ann=FALSE,xaxt="n",yaxt="n")
axis(1, at =seq(0,max(bins[1:13]),30), las=2)
axis(2, at =seq(0,max(bins_norm_durations_udp[1:14]),0.1), las=2)
box()
